...
![Query tab in pgadmin screenshot]({1BA04D53-B96D-430D-A894-A0DBCE372B93}.png)

## Insert taxi zones in postgres db (in case you did not before)
(or use the insert_taxi_zones_lookup.ipynb in pipeline)
